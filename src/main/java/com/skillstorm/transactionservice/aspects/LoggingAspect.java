package com.skillstorm.transactionservice.aspects;
...
public class LoggingAspect {
    ...
    // Pointcut for all methods in the com.skillstorm.transactionservice package:
    @Pointcut("within(com.skillstorm.transactionservice..*)")
